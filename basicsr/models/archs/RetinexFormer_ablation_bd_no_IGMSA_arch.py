...
class RetinexFormer_ablation_bd_no_IGMSA(nn.Module):
    def __init__(self, in_channels=3, out_channels=3, n_feat=31, stage=3, num_blocks=[1,1,1]):
        super(RetinexFormer_ablation_bd_no_IGMSA, self).__init__()
        self.stage = stage
...
#     model = RetinexFormer_ablation_bd_no_IGMSA(stage=1,n_feat=40,num_blocks=[1,2,2]).cuda()
#     print(model)
