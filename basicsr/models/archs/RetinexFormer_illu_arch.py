...
class Illumination_Estimator(nn.Module):
    ...
    def forward(self, img):
        ...
        mean_c = torch.mean(img, dim=1, keepdim=True)
        # stx()
...
#     model = RetinexFormer(stage=1,n_feat=40,num_blocks=[2,4,4]).cuda()
#     print(model)
